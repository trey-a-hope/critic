...
class NewCritiqueView extends StatefulWidget {
  const NewCritiqueView({
    Key key,
    @required this.critique,
    @required this.currentUser,
  }) : super(key: key);

  final NewCritiqueModel critique;
  final UserModel currentUser;

  @override
  State createState() => _NewCritiqueViewState();
}

class _NewCritiqueViewState extends State<NewCritiqueView> {
