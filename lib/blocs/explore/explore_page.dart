            ...
            child: Scaffold(
              appBar: TabBar(
                ...
                tabs: [
                  ...
                  _buildTab(
                      title: 'Biography', iconData: MdiIcons.accountDetails),
                  _buildTab(title: 'Comedy', iconData: MdiIcons.emoticon),
                  _buildTab(title: 'Crime', iconData: MdiIcons.pistol),
                  _buildTab(
                      title: 'Documentary',
                      iconData: MdiIcons.televisionClassic),
                  _buildTab(title: 'Drama', iconData: MdiIcons.emoticonCry),
                  _buildTab(title: 'Family', iconData: MdiIcons.motherNurse),
                  _buildTab(title: 'Fantasy', iconData: MdiIcons.unicorn),
                  _buildTab(title: 'Film-Noir', iconData: MdiIcons.hail),
                  _buildTab(
                      title: 'History', iconData: MdiIcons.bookOpenPageVariant),
                  _buildTab(title: 'Horror', iconData: MdiIcons.emoticonDevil),
                  _buildTab(title: 'Music', iconData: MdiIcons.music),
                  _buildTab(title: 'Musical', iconData: MdiIcons.danceBallroom),
                  _buildTab(title: 'Mystery', iconData: MdiIcons.headQuestion),
                  _buildTab(title: 'N/A', iconData: MdiIcons.setNone),
                  _buildTab(
                      title: 'Reality-TV', iconData: MdiIcons.televisionBox),
                  _buildTab(title: 'Romance', iconData: MdiIcons.heart),
                  _buildTab(title: 'Sci-Fi', iconData: MdiIcons.alien),
                  _buildTab(title: 'Short', iconData: MdiIcons.sizeS),
                  _buildTab(title: 'Sport', iconData: MdiIcons.basketball),
                  _buildTab(title: 'Talk-Show', iconData: MdiIcons.microphone),
                  _buildTab(title: 'Thriller', iconData: MdiIcons.halloween),
                  _buildTab(title: 'War', iconData: MdiIcons.medal),
                  _buildTab(
                      title: 'Western', iconData: MdiIcons.accountCowboyHat)
                ],
              ),
              body: TabBarView(
                controller: _tabController,
